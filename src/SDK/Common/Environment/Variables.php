...
interface Variables
{
    ...
    public const OTEL_EXPORTER_OTLP_SPAN_INSECURE = 'OTEL_EXPORTER_OTLP_SPAN_INSECURE';
    public const OTEL_EXPORTER_OTLP_METRIC_INSECURE = 'OTEL_EXPORTER_OTLP_METRIC_INSECURE';
    // Certificate File
