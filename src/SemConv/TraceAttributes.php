...
interface TraceAttributes
{
     ...
     */
    public const AZURE_RESOURCE_PROVIDER_NAMESPACE = 'azure.resource_provider.namespace';

    /**
     * The unique identifier of the service request. It's generated by the Azure service and returned with the response.
     */
    public const AZURE_SERVICE_REQUEST_ID = 'azure.service.request.id';
     ...
     */
    public const K8S_HPA_METRIC_TYPE = 'k8s.hpa.metric.type';
     ...
     */
    public const K8S_HUGEPAGE_SIZE = 'k8s.hugepage.size';
     ...
     */
    public const K8S_NODE_CONDITION_STATUS = 'k8s.node.condition.status';
     ...
     */
    public const K8S_NODE_CONDITION_TYPE = 'k8s.node.condition.type';
     ...
     */
    public const K8S_RESOURCEQUOTA_RESOURCE_NAME = 'k8s.resourcequota.resource_name';
     ...
     */
    public const K8S_STORAGECLASS_NAME = 'k8s.storageclass.name';
