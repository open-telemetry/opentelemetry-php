...
use OpenTelemetry\SDK\Trace\SpanProcessor\HttpMetricsSpanProcessor;
 ...
 */
final class SpanProcessorHttpMetrics implements ComponentProvider
{
    /**
    ...
    {
        return $builder->arrayNode('http_metrics');
    }
}
