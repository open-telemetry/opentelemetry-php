...
/**
 * @covers \OpenTelemetry\API\Common\Event\SimpleListenerProvider
 */
class SimpleListenerProviderTest extends TestCase
{
    private \OpenTelemetry\API\Common\Event\SimpleListenerProvider $provider;

    public function setUp(): void
    {
        $this->provider = new \OpenTelemetry\API\Common\Event\SimpleListenerProvider();
    }
