...
class EnumNodeTest extends TestCase
{
     ...
     */
    public function testEnumNodeExtendsSymfonyEnumNode(): void
    {
     ...
     */
    public function testEnumNodeUsesNodeTrait(): void
    {
     ...
     * @covers \OpenTelemetry\Config\SDK\Configuration\Internal\Node\EnumNode
     */
    public function testEnumNodeHasCorrectNamespace(): void
    {
     ...
     * @covers \OpenTelemetry\Config\SDK\Configuration\Internal\Node\EnumNode
     */
    public function testEnumNodeIsNotAbstract(): void
    {
        $reflection = new \ReflectionClass(EnumNode::class);
     ...
     * @covers \OpenTelemetry\Config\SDK\Configuration\Internal\Node\EnumNode
     */
    public function testEnumNodeInheritsFromSymfonyEnumNode(): void
    {
