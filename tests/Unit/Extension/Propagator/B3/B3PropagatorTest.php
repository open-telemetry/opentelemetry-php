...
class B3PropagatorTest extends TestCase
{
    ...
    public function test_extract_only_b3single_sampled_context_with_b3single_instance(): void
    {
        ...
        $this->assertEquals(
            SpanContext::create(self::B3_SINGLE_TRACE_ID_BASE16, self::B3_SINGLE_SPAN_ID_BASE16, SpanContextInterface::TRACE_FLAG_SAMPLED, null, true),
    ...
    public function test_extract_only_b3multi_sampled_context_with_b3single_instance(): void
    {
        ...
        $this->assertEquals(
            SpanContext::create(self::B3_MULTI_TRACE_ID_BASE16, self::B3_MULTI_SPAN_ID_BASE16, SpanContextInterface::TRACE_FLAG_SAMPLED, null, true),
            $this->getSpanContext($context)
        );
    }
    ...
    public function test_extract_b3_single_invalid_and_b3_multi_valid_context_with_b3single_instance($headerValue): void
    {
        ...
        $this->assertEquals(
            SpanContext::create(self::B3_MULTI_TRACE_ID_BASE16, self::B3_MULTI_SPAN_ID_BASE16, SpanContextInterface::TRACE_FLAG_DEFAULT, null, true),
            $this->getSpanContext($context)
        );
    }
