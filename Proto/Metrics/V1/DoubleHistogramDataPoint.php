 ...
 *
 * Generated from protobuf message <code>opentelemetry.proto.metrics.v1.DoubleHistogramDataPoint</code>
 */
class DoubleHistogramDataPoint extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .opentelemetry.proto.metrics.v1.DoubleExemplar exemplars = 8;</code>
     */
    private $exemplars;
     ...
     *           If we decide to also support (a, b] intervals we should add support for these by defining
     *           a boolean value which decides what type of intervals to use.
     *     @type \Opentelemetry\Proto\Metrics\V1\DoubleExemplar[]|\Google\Protobuf\Internal\RepeatedField $exemplars
     *           (Optional) List of exemplars collected from
     *           measurements that were used to form the data point
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .opentelemetry.proto.metrics.v1.DoubleExemplar exemplars = 8;</code>
     * @param \Opentelemetry\Proto\Metrics\V1\DoubleExemplar[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setExemplars($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Opentelemetry\Proto\Metrics\V1\DoubleExemplar::class);
        $this->exemplars = $arr;
