 ...
 *
 * Generated from protobuf message <code>opentelemetry.proto.metrics.v1.DoubleSummaryDataPoint</code>
 */
class DoubleSummaryDataPoint extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .opentelemetry.proto.metrics.v1.DoubleSummaryDataPoint.ValueAtQuantile quantile_values = 6;</code>
     */
     ...
     *           sum of the values in the population. If count is zero then this field
     *           must be zero.
     *     @type \Opentelemetry\Proto\Metrics\V1\DoubleSummaryDataPoint\ValueAtQuantile[]|\Google\Protobuf\Internal\RepeatedField $quantile_values
     *           (Optional) list of values at different quantiles of the distribution calculated
     *           from the current snapshot. The quantiles must be strictly increasing.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .opentelemetry.proto.metrics.v1.DoubleSummaryDataPoint.ValueAtQuantile quantile_values = 6;</code>
     * @param \Opentelemetry\Proto\Metrics\V1\DoubleSummaryDataPoint\ValueAtQuantile[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setQuantileValues($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Opentelemetry\Proto\Metrics\V1\DoubleSummaryDataPoint\ValueAtQuantile::class);
